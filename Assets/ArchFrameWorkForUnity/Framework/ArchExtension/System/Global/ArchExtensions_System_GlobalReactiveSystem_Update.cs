...
namespace Arch
{
	public abstract class GlobalUpdateSystem : GlobalReactiveSystem, IReactiveUpdate
	{
		public void Update()
		{
	...
	public abstract class GlobalUpdateSystem<T> : GlobalReactiveSystem<T>, IReactiveUpdate where T : struct, IComponent
	{
	...
	public abstract class GlobalUpdateSystem<T1, T2> : GlobalReactiveSystem<T1, T2>, IReactiveUpdate
	...
	public abstract class GlobalUpdateSystem<T1, T2, T3> : GlobalReactiveSystem<T1, T2, T3>, IReactiveUpdate
	...
	// 4 参数版本
	public abstract class GlobalUpdateSystem<T1, T2, T3, T4> : GlobalReactiveSystem<T1, T2, T3, T4>, IReactiveUpdate
	...
	// 5 参数版本
	public abstract class GlobalUpdateSystem<T1, T2, T3, T4, T5> : GlobalReactiveSystem<T1, T2, T3, T4, T5>, IReactiveUpdate
		where T1 : struct, IComponent
		where T2 : struct, IComponent
		where T3 : struct, IComponent
		where T4 : struct, IComponent
	...
	// 6 参数版本
	public abstract class GlobalUpdateSystem<T1, T2, T3, T4, T5, T6> : GlobalReactiveSystem<T1, T2, T3, T4, T5, T6>, IReactiveUpdate
		where T1 : struct, IComponent
		where T2 : struct, IComponent
		where T3 : struct, IComponent
		where T4 : struct, IComponent
