...
namespace Arch.Net
{
    // 1
    [System]
    public abstract class NetSyncAwakeSystem<T> : GlobalAwakeSystem<T> where T : struct, IComponent
    {
    ...
    // 2
    [System]
    public abstract class NetSyncAwakeSystem<T1, T2> : GlobalAwakeSystem<T1, T2>
    ...
    // 3
    [System]
    public abstract class NetSyncAwakeSystem<T1, T2, T3> : GlobalAwakeSystem<T1, T2, T3>
    ...
    // 4
    [System]
    public abstract class NetSyncAwakeSystem<T1, T2, T3, T4> : GlobalAwakeSystem<T1, T2, T3, T4>
    ...
    // 5
    [System]
    public abstract class NetSyncAwakeSystem<T1, T2, T3, T4, T5> : GlobalAwakeSystem<T1, T2, T3, T4, T5>
    ...
    // 6
    [System]
    public abstract class NetSyncAwakeSystem<T1, T2, T3, T4, T5, T6> : GlobalAwakeSystem<T1, T2, T3, T4, T5, T6>
