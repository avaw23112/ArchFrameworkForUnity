...
{
    [System]
    public abstract class NetSyncUpdateSystem : GlobalUpdateSystem
    {
    ...
    // 1
    [System]
    public abstract class NetSyncUpdateSystem<T> : GlobalUpdateSystem<T> where T : struct, IComponent
    {
    ...
    // 2
    [System]
    public abstract class NetSyncUpdateSystem<T1, T2> : GlobalUpdateSystem<T1, T2>
    ...
    // 3
    [System]
    public abstract class NetSyncUpdateSystem<T1, T2, T3> : GlobalUpdateSystem<T1, T2, T3>
    ...
    // 4
    [System]
    public abstract class NetSyncUpdateSystem<T1, T2, T3, T4> : GlobalUpdateSystem<T1, T2, T3, T4>
    ...
    // 5
    [System]
    public abstract class NetSyncUpdateSystem<T1, T2, T3, T4, T5> : GlobalUpdateSystem<T1, T2, T3, T4, T5>
    ...
    // 6
    [System]
    public abstract class NetSyncUpdateSystem<T1, T2, T3, T4, T5, T6> : GlobalUpdateSystem<T1, T2, T3, T4, T5, T6>
