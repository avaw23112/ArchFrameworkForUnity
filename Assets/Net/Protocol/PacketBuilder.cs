...
namespace Arch.Net
{
    ...
    public static class PacketBuilder
    {
        ...
        /// <summary>
        /// Build a Sync packet with segmented payload using a writer callback to avoid intermediate segment arrays.
        /// The writer is invoked per segment with a destination span of exact 'length' bytes to fill.
        /// </summary>
