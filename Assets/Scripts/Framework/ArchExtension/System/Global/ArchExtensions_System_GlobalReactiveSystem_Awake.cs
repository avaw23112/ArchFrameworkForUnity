...
namespace Arch
{
	...
	/// </summary>
	public abstract class GlobalAwakeSystem : ReactiveSystem, IReactiveAwake
	{
	...
	public abstract class GlobalAwakeSystem<T> : ReactiveSystem<T>, IReactiveAwake where T : struct, IComponent
	{
		public void SubcribeEntityAwake()
		{
			foreach (World WorldNamed in NamedWorld.Instance.NamedWorlds)
	...
	public abstract class GlobalAwakeSystem<T1, T2> : ReactiveSystem<T1, T2>, IReactiveAwake
	...
	public abstract class GlobalAwakeSystem<T1, T2, T3> : ReactiveSystem<T1, T2, T3>, IReactiveAwake
		where T1 : struct, IComponent
		where T2 : struct, IComponent
	...
	public abstract class GlobalAwakeSystem<T1, T2, T3, T4> : ReactiveSystem<T1, T2, T3, T4>, IReactiveAwake
		where T1 : struct, IComponent
		where T2 : struct, IComponent
		where T3 : struct, IComponent
	...
	public abstract class GlobalAwakeSystem<T1, T2, T3, T4, T5> : ReactiveSystem<T1, T2, T3, T4, T5>, IReactiveAwake
		where T1 : struct, IComponent
		where T2 : struct, IComponent
		where T3 : struct, IComponent
		where T4 : struct, IComponent
	...
	public abstract class GlobalAwakeSystem<T1, T2, T3, T4, T5, T6> : ReactiveSystem<T1, T2, T3, T4, T5, T6>, IReactiveAwake
		where T1 : struct, IComponent
		where T2 : struct, IComponent
		where T3 : struct, IComponent
		where T4 : struct, IComponent
