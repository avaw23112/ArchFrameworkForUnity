...
public class AttributeSystemTest_1AttributeSystem : AttributeSystem<AttributeSystemTest_1Attribute>
{
    ...
    {
        Tools.Logger.Debug("AttributeSystemTest_1AttributeSystem.Process: " + attribute.name);
        if (derectType == typeof(AttributeSystemTest_1))
        {
            Tools.Logger.Debug("AttributeSystemTest_1AttributeSystem.Process: " + attribute.name + " is applied to " + derectType.Name);
        }
    }
}
